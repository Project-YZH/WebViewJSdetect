...
def validate_chrome_extension(extension_path, dx=False):
    ...
    # """
    """
    check whether an Android app assets directory is valid by whether it includes any .js files
    Args:
        assets_path--extension_path: the path to the assets directory
    Returns:
    ...
    if not js_files_exist:
        Error_msg = "Error: No .js files found in " + extension_path
